...
//   console.log(arr)
//   //removendo nulls, undefined e strings vazias
...
//   if (movie.cast) tags = tags.concat(...movie.cast.map((actor) => simplify(actor)))

//   if (movie.countries) tags = tags.concat(...movie.countries.map((country) => simplify(country)))

//   if (movie.directors) tags = tags.concat(...movie.directors.map((director) => simplify(director)))

//   if (movie.genres) tags = tags.concat(...movie.genres.map((genre) => simplify(genre)))
//   return tags
// }
